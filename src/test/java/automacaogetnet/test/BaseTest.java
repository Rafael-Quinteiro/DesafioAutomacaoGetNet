...
/*Classe base utilizada para todos os testes do projeto. Ao criar um novo teste, deve ser feito a herança dessa classe. */
    public abstract class BaseTest {
         ...
         */
        @BeforeClass
        public static void abrirGetnet() throws IOException {
    ...
    */
    ...
    /**
    * Método responsável por ir para a página inicial do Getnet.
    * @param driver Driver da página.
    */
    protected void irParaPaginaInicialDoGetNet(WebDriver driver) {
        driver.get(Constantes.URL_BASE);          
    }
}
